...
public static void userMove(){
    boolean won,pit=true;
    Scanner input = new Scanner(System.in);
    boolean step=true;
    String move;
    do{
        do{
            if((step == false)&& (pit == false))
            ...
            move_count++;
            if(move.equals("R"))
                step =myMap.canIMoveRight();
            else if(move.equals("L"))
                step =myMap.canIMoveLeft();
            else if(move.equals("U"))
                step=myMap.canIMoveUp();
            else if(move.equals("D"))
                step =myMap.canIMoveDown();
            else{
                ...
                if(pit==true){
                    ...
                    if((jump.equals("yes"))|| (jump.equals("y"))){
                        ...
                        myMap.printMap();
                            ...
                            System.out.println("Oh NOOOOO you fell into a pit- you lose!");
                            System.exit(0);
                        }
        ...
        if(move.equals("R"))
            ...
            myMap.moveDown();
        movesMessage(move_count);
        myMap.printMap();
        won = myMap.didIWin();
        if((move_count==100)&&(won == false)){ 
            System.out.println("Sorry, but you didn't escape in time- you lose!");
            System.exit(0);
        }
    }while(won == false);
    System.out.println("Congratulations, you made it out alive! and you did it in "+move_count+" moves");
    }
